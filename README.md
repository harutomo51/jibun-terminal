...
アプリ起動後、PowerShellプロンプトが表示されたら `docs/verification-checklist.md` の項目を順に確認してください。特に `dir`、`Get-ChildItem`、`git --version`、`npm --version`、日本語入力、コピー/貼り付け、`Ctrl+C`、ウィンドウリサイズ、背景切替、任意背景色、アプリ終了後のプロセス残存を重点的に見ます。
